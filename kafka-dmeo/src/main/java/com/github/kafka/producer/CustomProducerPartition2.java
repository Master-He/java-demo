 ...
 */
public class CustomProducerPartition2 {
    ...
    public static void main(String[] args) {
        ...
        // 自定义分区器
        properties.put(ProducerConfig.PARTITIONER_CLASS_CONFIG, "com.github.kafka.producer.MyPartitioner");
        ...
        kafkaProducer.send(new ProducerRecord<>("first","123"));
